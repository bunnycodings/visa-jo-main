        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-xl p-8 text-white">
              ...
              <p className="text-blue-100 mb-6">Our team is available 24/7 to assist you with your visa needs.</p>
          ...
          <div className="lg:col-span-2">
            <form onSubmit={submitForm} className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Contact our Consultants for Inquiries...</h2>
                <p className="text-gray-600 text-lg mt-2">Leave Us A Message</p>
              </div>
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Your Inquiries.... *</label>
                  <textarea 
                    rows={4}
                    className="w-full border-2 border-gray-300 text-gray-900 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300" 
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                {status === 'success' && (
                  <div className="flex items-center gap-2 text-green-600 bg-green-50 px-6 py-3 rounded-xl">
                    ...
                    <span className="font-semibold">Thanks! We'll get back to you soon.</span>
                  </div>
                )}
              </div>
            </form>
