    ...
    <section className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-900 via-blue-800 to-cyan-700 z-0 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-20 -left-20 w-80 h-80 bg-[#145EFF] opacity-10 rounded-full blur-3xl animate-blob"></div>
          ...
          <div className="absolute bottom-20 left-1/4 w-72 h-72 bg-[#145EFF] opacity-10 rounded-full blur-3xl animate-blob animation-delay-4000"></div>
        </div>
